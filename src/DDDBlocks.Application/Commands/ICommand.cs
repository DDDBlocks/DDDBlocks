using DDDBlocks.Application.Requests;
using MediatR;

namespace DDDBlocks.Application.Commands;
...
/// </summary>
public interface ICommand : IRequest, IRequestIdentity
{
}
...
public interface ICommand<out TResult> : IRequest<TResult>, IRequestIdentity
{
}